 ...
 *
 * @alias: name alias to be printed.
 *
 * Return: zero if sucess other number if its declared in the arguments.
 */
 ...
 *
 * @name: name the requested alias.
 *
 * Return: zero if or other number if its declared in the arguments.
 */
 ...
 *
 * @alias_string: alias to be seted.
 *
 * @data: struct for the program data.
 *
 * Return: zero if sucess number if its declared in the arguments.
 */
