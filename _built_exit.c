...
/**
 * builtin_exit - exit of the program with status.
 *
 * @data: struct for the program data.
 *
 * Return: zero if other number if its declared in the arguments.
 */
 ...
 * @data: struct for the program data.
 *
 * Return: zero other number if its declared in the arguments.
 */
 ...
 *
 * Return: zero or other number if its declared in the arguments.
 */
...
/**
 * builtin_alias - add remove or show alias.
 *
 * @data: struct for the program data.
 *
 * Return: zero or other number if its declared in the argument.
 */
